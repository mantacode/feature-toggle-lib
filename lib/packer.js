...
var getCode = exports.getCode = function(chunk) {
  ...
  // range, plus a few symbols in each end.
...
// above. This converts a series of characters in binary representations,
...
exports.pack = function(config) {
  ...
  // Separate into chunks of 5 (this helps ensure that the final character representation
  // falls between 64 ("@") and 95 ("_").
